...
freertos/src/%.o: ../freertos/src/%.c
	...
	arm-none-eabi-gcc -D__REDLIB__ -DNDEBUG -D__CODE_RED -D__USE_LPCOPEN -DCORE_M3 -I"/home/gurwinder/lpc_chip_175x_6x/inc" -I"/home/gurwinder/lpc_board_nxp_lpcxpresso_1769/inc" -I"/home/gurwinder/freertos_blinky/example/inc" -I"/home/gurwinder/freertos_blinky/freertos/inc" -Os -g -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
